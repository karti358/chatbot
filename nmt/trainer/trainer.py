...
class Trainer:
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, (data, inp_target, out_target) in tqdm(enumerate(self.dataloader)):
            num_batches += 1
            ...
            if batch_idx+1 % 10 == 0:
                print(f"Training -> Epoch {epoch} / {self.num_epochs} , {batch_idx+1} batches completed.")
    ...
    def _valid_epoch(self, epoch):
        ...
        with torch.no_grad():
            for batch_idx, (data, target) in tqdm(enumerate(self.valid_dataloader)):
                num_batches += 1
